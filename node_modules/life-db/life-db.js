module.exports = {
	...
	insert : function(databaseName, pageName, data, callBack) {
		var presentObject = this;console.log(-1);
		presentObject.checkIfDatabaseExists(databaseName, function(flag) {
			if(flag) { // database exists
				presentObject.checkIfPageExists(databaseName, pageName, function(flag) {console.log(0);
					if(flag) {// page exists
	...
	initiateInsert : function(databaseName, pageName, data, callBack) {console.log(1);
		var presentObject = this;
		var databasePath = presentObject.rootFolderName+"/"+databaseName;
		var pagePath = databasePath + "/" + pageName + ".db";
		presentObject.getPageContent(pagePath, function(dataFromPage) {console.log(2);
			var dataLength = 1;
	...
	getPageContent : function(pagePath, callBack) { // returns page content from page path
		var fs = require('fs');console.log(pagePath);
		var presentObject = this;
